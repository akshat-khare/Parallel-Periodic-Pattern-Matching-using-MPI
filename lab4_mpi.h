...
Arguments:
    ...
    num_patterns: integer containing #patterns to be searched in the text (input)
    m_set : integer array containing length of patterns (input)
            ...
            --------------------------------------------------------------------------
    p_set : integer array containing length of periods in patterns (input)
            #elements in p_set = num_patterns
            -----------------------------------------------------------------------------------
            | period(pattern[0]) | period(pattern[1]) | ... | period(pattern[num_patterns-1]) |
            -----------------------------------------------------------------------------------
    pattern_set : array of character array containing patterns to be searched (input)
